...
function GreenStops(){
    ...
    useEffect(()=> { 
        async function fetchData() {
            const result = await axios('https://api-v3.mbta.com/schedules?filter[route]=Green',);
        ...
        return(
            <div>
                {Stops.map(stop =>(
                    ...
                    >
                        <Card.Body>
                            <Card.Title>Green Line Arrival and Departure Times</Card.Title>
